...
exports.validator_product = [
    ...
    (0, express_validator_1.check)('description').if((0, express_validator_1.check)('description').exists()).isLength({ min: 6 }),
    (0, express_validator_1.check)('category').if((0, express_validator_1.check)('category').exists()).isLength({ min: 6 }),
